...
يتم تحديث أوقات الصلاة يوميا لتعكس التغيرات في شروق الشمس وغروبها والعوامل الأخرى ذات الصلة. يتم إعداد جدول كل يوم لكل من    <a href='/hijri-date'>التاريخ الميلادي والهجري</a> ، باستخدام البيانات الفلكية الخاصة بالرياض`,
    },
